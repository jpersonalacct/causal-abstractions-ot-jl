...
def run_alignment_pipeline(
    ...
    if config.method == "gw":
        ...
        cost_cross_tensor = _squared_euclidean_cost(variable_signatures, site_signatures)
        cost_cross = cost_cross_tensor.detach().cpu().numpy()
        transport, transport_meta = solve_ot_transport(variable_signatures, site_signatures, config)
        extra_payload = {"cost_cross": cost_cross.tolist(), "cost_metric": "sqeuclidean"}
