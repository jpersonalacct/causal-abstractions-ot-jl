"""Reusable comparison runner for hierarchical equality experiments."""
...
class CompareExperimentConfig:
    """Config controlling one end-to-end equality comparison run."""
...
def run_comparison_with_model(
    *,
    ...
    """Run the shared OT/DAS alignment evaluation from an in-memory model."""
...
def run_comparison_from_checkpoint(
    *,
    problem,
    device,
    backbone_train_config: EqualityTrainConfig,
    config: CompareExperimentConfig,
) -> dict[str, object]:
